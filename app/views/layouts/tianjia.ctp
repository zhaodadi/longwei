...
<!-- Tooltips -->
<?php echo $this->Html->script(array('jquery/jquery.tooltip','jquery/jquery.dimensions')); ?>
<script type="text/javascript">
$(function() {
...
<?php echo $this->Html->script(array('jquery/date','jquery/jquery.datePicker')); ?>
<script type="text/javascript" charset="utf-8">
        $(function()
{
...
<div id="page-top">
	...
	<!-- start logo -->
	<div id="logo">
	<a href=""><?php echo $this->Html->image('images/shared/logo.png', array('alt' => 'logo')); ?></a>
	</div>
	<!-- end logo -->
...
<div id="footer">
	<!--  start footer-left -->
	<div id="footer-left">
	龙威ERP系统 &copy; Copyright Dadi. <a href="">www.daditech.com</a>. All rights reserved.</div>
	<!--  end footer-left -->
	<div class="clear">&nbsp;</div>
</div>
<!-- end footer -->
