<div class="receipts index">
	...
	<tr<?php echo $class;?>>
		...
		<td>
			<?php echo $this->Html->link($receipt['Product']['name'], array('controller' => 'products', 'action' => 'view', $receipt['Product']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($receipt['Ingredient']['name'], array('controller' => 'ingredients', 'action' => 'view', $receipt['Ingredient']['id'])); ?>
		</td>
		<td><?php echo $receipt['Receipt']['amount']; ?>&nbsp;</td>
		<td><?php echo $receipt['Receipt']['unit']; ?>&nbsp;</td>
		<td><?php echo $receipt['Receipt']['modifier']; ?>&nbsp;</td>
		<td><?php echo $receipt['Receipt']['created']; ?>&nbsp;</td>
		<td><?php echo $receipt['Receipt']['modified']; ?>&nbsp;</td>
		<td><?php echo $receipt['Receipt']['extra']; ?>&nbsp;</td>
		<td class="actions">
