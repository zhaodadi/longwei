	...
	<td><!-- start id-form -->
		...
		<tr><th valign="top">原料组成</th>
            ...
            <table id="add_ingredient">
                ...
                <tr>
                	<td><center><?php echo $this->Form->input('Receipt.0.ingredient_id', array( 'label' => false,'div' => false, 'class' => '')); ?></center></td>
                    <td><?php echo $this->Form->input('Receipt.0.amount', array( 'label' => false,'div' => false, 'class' => '')); ?></td>
					<td><?php echo $this->Form->input('Receipt.0.unit', array( 'label' => false,'div' => false, 'class' => '')); ?></td>
                </tr>
            </table>
            </td>
		</tr>
